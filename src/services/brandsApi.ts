...
export async function ROLEX_API(formData: any) {
    ...
    try {
        ...
        const response = await axios.post(`${BRANDS_API_1}/rolex`, formData);
...
export async function NIKE_API(formData: any) {
    ...
    try {
        ...
        const response = await axios.post(`${BRANDS_API_2}/nike`, formData);
...
export async function DIOR_API(formData: any) {
    ...
    try {
        ...
        const response = await axios.post(`${BRANDS_API_3}/dior`, formData);
...
export async function CELINE_API(formData: any) {
    ...
    try {
        ...
        const response = await axios.post(`${BRANDS_API_3}/celine`, formData);
...
export async function LV_API(formData: any) {
    ...
    try {
        ...
        const response = await axios.post(`${BRANDS_API_4}/lv`, formData);
...
export async function VALENTINO_API(formData: any) {
    ...
    try {
        ...
        const response = await axios.post(`${BRANDS_API_4}/valentino`, formData);
...
export async function PRADA_API(formData: any) {
    ...
    try {
        ...
        const response = await axios.post(`${BRANDS_API_5}/prada`, formData);
...
export async function HERMES_API(formData: any) {
    ...
    try {
        ...
        const response = await axios.post(`${BRANDS_API_6}/hermes`, formData);
...
export async function YSL_API(formData: any) {
    ...
    try {
        ...
        const response = await axios.post(`${BRANDS_API_6}/ysl`, formData);
